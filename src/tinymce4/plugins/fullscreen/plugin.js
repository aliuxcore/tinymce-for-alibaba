...
tinymce.PluginManager.add('fullscreen', function(editor) {
	...
	function toggleFullscreen() {
		...
		if (fullscreenState) {
            ...
            var computeTopFun = editor.settings.full_screen_compute_top_fun;
            if (computeTopFun) {
                var top = computeTopFun();
                top != undefined && DOM.setStyle(editorContainer, 'top', top);
            }
            ...
            DOM.setStyle(editorContainer, 'top', null);
	...
	editor.addButton('fullscreen', {
		tooltip: editor.getSettingsMessage("button.fullscreen"),
		shortcut: 'Ctrl+Alt+F',
		onClick: toggleFullscreen,
		onPostRender: function() {
			var self = this;
